...
#import "EmployerChatListViewController.h"

@interface EmployerChatListViewController ()
{
...
@implementation EmployerChatListViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DashboardTableViewCell *cell = [self.listChatTableView dequeueReusableCellWithIdentifier:CellIdentifier];
