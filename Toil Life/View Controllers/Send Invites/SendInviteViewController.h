...
@interface SendInviteViewController : UIViewController<UITextViewDelegate,UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
@property (weak, nonatomic) NSString *toilerID;
